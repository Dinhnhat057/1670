    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $.each(response.data, function (index, value) {
                ...
                str += "<img class='full_width'><div class='result__item--time'>" + value.address + "</div></div>";
                str += `<div class='result__item--name'><h2 class='result__name--title'><a href='/tin-tuyen-dung/${value.name}-${value.id}' class='result__name--link text-line-1'>${value.name}</a>`;
                str += "<span class='result__name--save'><a href='' title='Lưu tin tuyển dụng'><i class='fa-solid fa-heart'></i></a></span></h2>";
                str += `<div class='result__name--employer mb-5'><a class='result__employer--link text-line-1'><span class='result__icon'>`;
                ...
                str += "Ngày đăng: <span>" + value.createdDate + "</span></p><p class='result__date--end mb-0'>Hết hạn: <span>" + value.dealine + "</span></p></div>";
                str += "</div></div></div>";
